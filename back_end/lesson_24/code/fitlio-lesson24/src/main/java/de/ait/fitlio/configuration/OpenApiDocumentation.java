...
import de.ait.fitlio.secutrity.config.SecurityConfig;
...
public class OpenApiDocumentation {
    static Paths buildAuthenticationPath() {
        return new Paths()
                .addPathItem(SecurityConfig.LOGIN_ENDPOINT, buildAuthenticationPathItem())
                .addPathItem(SecurityConfig.LOGOUT_ENDPOINT, buildLogoutPathItem());
    }
